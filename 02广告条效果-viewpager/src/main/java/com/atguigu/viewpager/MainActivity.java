...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0 ;i < imageIds.length;i++){
            ...
            ll_point_group.addView(point);//把指示器添加到容器中
        }
    ...
    class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
         ...
         * @param positionOffsetPixels 在屏幕上滑动的像素数
         */
        @Override
        ...
        public void onPageScrollStateChanged(int state) {
            if(state == ViewPager.SCROLL_STATE_DRAGGING){ //viewPage页面拖拽时
                isDragging = true;
                handler.removeCallbacksAndMessages(null);
                Log.e(TAG,"SCROLL_STATE_DRAGGING-------------------");
            }else if(state == ViewPager.SCROLL_STATE_SETTLING){  //viewPage页面滑动时
                Log.e(TAG,"SCROLL_STATE_SETTLING-----------------");

            }else if(state == ViewPager.SCROLL_STATE_IDLE&&isDragging){ // viewPage页面空闲时
                isDragging = false;
...
//            return imageViews.size();
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            Log.e(TAG, "instantiateItem==" + realPosition );
...
//            super.destroyItem(container, position, object);这句一定要注释掉
